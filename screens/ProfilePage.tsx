...
import { LIGHTBLUE, WHITE, DARKRED, BACKGROUNDCOLOR4, BACKGROUNDCOLOR2 } from '../constants/Colors';
...
function ProfilePage(props: UserProfileProps) {
  ...
  const formatMail = userProfile.mail === '0' ? 'fill in mail' : userProfile.mail;
  const formatTelefon = userProfile.telefon === '0' ? 'fill in mail' : userProfile.telefon;
  const formatLocation = userProfile.location === '0' ? 'fill in mail' : userProfile.location;
  const formatBirthdate = userProfile.birthdate === '0' ? 'fill in mail' : userProfile.birthdate;
  const formatStreet = userProfile.street === '0' ? 'fill in mail' : userProfile.street;  
  const formatPostalCode = userProfile.postalcode === '0' ? 'fill in mail' : userProfile.postalcode;
    ...
    <Grid>
      <Row size={4}>
        <View>
          ...
          <View style={[styles.centeredView ,{width:width, height:height*0.40}]}>
            ...
            <View style={{flexDirection:'row'}}>  
              <ProfileTextContainer text={formatLocation} outerWidth={width*0.47}/>
              <View style={styles.minorSpace}/>
              <ProfileTextContainer text={formatPostalCode} outerWidth={width*0.3}/>
            </View>  
